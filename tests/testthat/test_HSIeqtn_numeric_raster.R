...
obs_tree_num <- raster::raster(ncol = 2, nrow = 2, vals = rep_len(1, 4))
obs_avg_dbh  <- raster::raster(ncol = 2, nrow = 2, vals = rep_len(1, 4))
obs_can_cov  <- raster::raster(ncol = 2, nrow = 2, vals = rep_len(1, 4))
...
obs_zooplankton   <- raster::raster(ncol = 2, nrow = 2, vals = rep_len(1, 4))
sal_spring_summer <- raster::raster(ncol = 2, nrow = 2, vals = rep_len(1, 4))
wtr_temp_surface  <- raster::raster(ncol = 2, nrow = 2, vals = rep_len(1, 4))
