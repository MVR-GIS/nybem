...
HSIplotter(NYBEM.est.sub.soft.sav, 
...
NYBEM.est.sub.soft.clam_labels <- data.frame(
  label = c("Salinity (psu)", "Sand Composition (%)", 
            "SAV Index"),
  variable = c("salinity.clam", "substrate.clam.sand", 
               "Isav")
)
```

```{r fig.width=4, fig.height=4}
HSIplotter(NYBEM.est.sub.soft.clam, 
